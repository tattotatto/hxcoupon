  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        responseExample: { code: 0, message: 'ok', data: { coupon_id: 1, coupon_code: 'ABC12DEF34GH', discount_value: 10, actual_amount: 189.00, used_at: '2025-01-01T14:00:00Z' } },
      },
      {
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        responseExample: { code: 0, message: 'ok', data: { total: 1, items: [{ coupon_id: 1, coupon_code: 'XYZ12ABC34DE', template_name: '满减券', type: 'full_reduction', discount_value: 10, threshold_amount: 100, valid_end: '2025-12-31T23:59:59Z', stackable: false }] } },
      },
      {
        ...
        responseExample: { code: 0, message: 'ok', data: { total: 1, items: [{ coupon_id: 1, coupon_code: 'XYZ12ABC34DE', template_name: '满减券', type: 'full_reduction', discount_value: 10, threshold_amount: 100, status: 'unused', valid_start: '2025-01-01T00:00:00Z', valid_end: '2025-02-01T00:00:00Z' }] } },
      },
      {
        ...
        responseExample: { code: 0, message: 'ok', data: { coupon_id: 1, coupon_code: 'XYZ12ABC34DE', template_name: '满减券', type: 'full_reduction', discount_value: 10, threshold_amount: 100, status: 'unused', user_phone: '13800138000', source_store_name: '旗舰店', valid_start: '2025-01-01T00:00:00Z', valid_end: '2025-02-01T00:00:00Z', receive_time: '2025-01-01T12:00:00Z', records: [] } },
      },
      {
        ...
        responseExample: { code: 0, message: 'ok', data: { coupon_id: 1, coupon_code: 'XYZ12ABC34DE', discount_value: 10, actual_amount: 189.00, used_at: '2025-01-01T14:00:00Z' } },
      },
      {
        ...
        responseExample: { code: 0, message: 'ok', data: { coupon_id: 1, coupon_code: 'XYZ12ABC34DE', new_status: 'unused', restored: true } },
      },
    ],
  },
];
