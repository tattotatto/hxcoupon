...
import { PlusOutlined, EditOutlined, KeyOutlined, ReloadOutlined, UploadOutlined, DeleteOutlined } from '@ant-design/icons';
        ...
        <Space>
          ...
          <Upload
            ...
            beforeUpload={(file) => {
              ...
              storeApi.uploadQrCode(record.id, file)
              ...
              <Space direction="vertical" style={{ width: '100%' }}>
                ...
                <Upload
                  ...
                  beforeUpload={(file) => {
                    ...
                    storeApi.uploadQrCode(modal.editing.id, file)
                      .then(() => { message.success('QR码上传成功'); fetchData(); })
                      .catch(() => message.error('上传失败'))
                      .finally(() => setUploading(null));
                    return false;
